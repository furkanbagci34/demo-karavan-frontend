...
export async function generateOfferPdf({
    ...
    try {
        logoBase64 = await getBase64FromUrl("/images/mefsystem-icon.png");
    } catch (error) {
        ...
        content: [
            {
                columns: [
                    [
                        { text: "MEFSYSTEM KARAVAN SANAYİ VE TİC A.Ş", style: "companyTitle", margin: [0, 0, 0, 2] },
            ...
            !hideIntroTexts
                ? {
                      text: "MefSystem Karavan olarak, TSE ve TÜV testlerinden geçmiş, güvenilir ve dayanıklı ürünler ile en yüksek standartlarda üretim yapıyoruz. Karavanlarımızı, ithal bileşenler kullanarak hazırlıyor ve sektörün en iyi markalarıyla çalışıyoruz. Ayrıca, SCA, Vbair ve Stide markalarının yetkili satış ve servis noktası olarak, yalnızca en kaliteli ürünleri sunmakla kalmıyor, satış sonrası destek ve garanti kapsamında da profesyonel hizmet sağlıyoruz.",
                      fontSize: 9,
                      margin: [0, 0, 0, 4],
                      unbreakable: true,
                  }
