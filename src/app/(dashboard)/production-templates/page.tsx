...
import { Plus, Pencil, Trash2, Loader2, AlertTriangle, Search, X, Car, MapPin } from "lucide-react";
...
export default function ProductionTemplatesListPage() {
    ...
    const handleRowClick = (templateId: number) => {
        router.push(`/production-templates/edit/${templateId}`);
    };
                                            ...
                                            >
                                                ...
                                                <TableCell className="flex items-center justify-center gap-1">
                                                    <Button
                                                        ...
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                                                            router.push(`/production-templates/edit/${template.id}`);
                                                        }}
                                                        title="Düzenle"
                                                    >
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        <Button
                                                            ...
                                                            onClick={(e) => {
                                                                e.stopPropagation();
                                                                router.push(
                                                                    `/production-templates/edit/${template.id}`
                                                                );
                                                            }}
                                                            title="Düzenle"
                                                        >
