...
export default function ProductionExecutionListPage() {
    ...
    const paginatedExecutions = productionExecutions.slice((currentPage - 1) * PAGE_SIZE, currentPage * PAGE_SIZE);
            ...
            <div className="flex flex-1 flex-col p-4 sm:p-6 space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Üretim planı detayına gitmek için satırın üzerine tıklayınız.</CardDescription>
                    </CardHeader>
                                        ...
                                        paginatedExecutions.map((execution) => (
                                            ...
                                            >
                                                ...
                                                <TableCell className="text-center max-w-xs">
                                                    <div className="truncate" title={execution.description || ""}>
            ...
            <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            <strong>
                                {executionToDelete?.production_plan_name || `Plan #${executionToDelete?.id}`}
                            </strong>{" "}
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={handleDeleteExecution} className="bg-red-600 hover:bg-red-700">
                            Üretim Planını Sil
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
